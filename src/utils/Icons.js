...
export const dollar = <i className="fa-solid ">₹</i>
...
export const tickets = <i className="fa-solid fa-ticket"></i>;
export const health = <i className="fa-solid fa-hospital"></i>;
export const tourGuide = <i className="fa-solid fa-route"></i>;
export const hotels = <i className="fa-solid fa-hotel"></i>;
